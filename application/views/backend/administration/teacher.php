...
<a href="<?php echo site_url('administration/teacher_import');?>"
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo site_url('administration/teacher_profile/'.$row['teacher_id']);?>">
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                          <a href="#" onclick="confirm_modal('<?php echo site_url('administration/teacher/delete/'.$row['teacher_id']);?>');">
