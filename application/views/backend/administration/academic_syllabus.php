		    	...
		    	<div class="tabs-vertical-env">
					...
					?>
						<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
							<a href="<?php echo site_url('administration/academic_syllabus/' . $row['class_id']);?>">
									...
									<tr>
										...
										<td align="center">
											<a class="btn btn-default btn-xs"
												href="<?php echo site_url('administration/download_academic_syllabus/' . $row['academic_syllabus_code']);?>">
												<i class="entypo-download"></i>
											</a>
											<a href="#" class="btn btn-danger btn-xs"
												onclick="confirm_modal('<?php echo site_url('administration/delete_academic_syllabus/' . $row['academic_syllabus_code']);?>');">
