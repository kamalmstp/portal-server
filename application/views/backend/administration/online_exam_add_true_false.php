...
<?php echo form_open(site_url('administration/manage_online_exam_question/'.$online_exam_id.'/add/true_false') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
