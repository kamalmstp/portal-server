...
<div class="row">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo site_url('administration/attendance_selector');?>" class="form">
            	<tr class="gradeA">
                    <td>
...
<form method="post" 
    action="<?php echo site_url('administration/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session);?>">
    <div class="col-sm-offset-3 col-md-6">
        <table  class="table table-bordered">
    		<thead>
    			<tr class="gradeA">
