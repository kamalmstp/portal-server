...
?>
<div class="row">
    <?php echo form_open(site_url('administration/manage_online_exam/edit') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
...
<script type="text/javascript">
	function get_class_sections(class_id) {
    	...
    	$.ajax({
            url: '<?php echo site_url('administration/get_class_section_selector/');?>' + class_id ,
    ...
    function get_class_subject(class_id) {
    	...
    	$.ajax({
            url: '<?php echo site_url('administration/get_class_subject_selector/');?>' + class_id ,
            success: function(response)
            {
