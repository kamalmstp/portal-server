...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open(site_url('administration/update_online_exam_question/'.$param2.'/update'.'/'.$question_details['online_exam_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
