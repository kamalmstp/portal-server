<div class="pull-right" style="text-align: right; margin-top: -30px;">
  <a href="<?php echo site_url('administration/group_message'); ?>" class="btn btn-blue"><i class="fa fa-comments" aria-hidden="true"></i> <?php echo get_phrase('group_message'); ?></a>
</div>
<hr />
<div class="mail-env">
    ...
    <div class="mail-sidebar">
        ...
        <div class="mail-sidebar-row">
            <a href="<?php echo site_url('administration/message/message_new'); ?>" class="btn btn-success btn-block">
        ...
        <ul class="mail-menu">
            ...
            foreach ($message_threads as $row):
                ...
                <li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
                    <a href="<?php echo site_url('administration/message/message_read/'.$row['message_thread_code']); ?>" style="padding:12px;">
