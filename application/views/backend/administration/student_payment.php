<div class="row">
	<div class="col-md-12">
            ...
            <br>
				...
				<?php echo form_open(site_url('administration/invoice/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
				<div class="row">
					<div class="col-md-6">
				...
				<?php echo form_open(site_url('administration/invoice/create_mass_invoice') , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
				<br>
				<div class="row">
...
<script type="text/javascript">
    function get_class_students(class_id) {
        if (class_id !== '') {
        $.ajax({
            url: '<?php echo site_url('administration/get_class_students/');?>' + class_id ,
...
jQuery(document).ready(function($) {
    ...
    function get_class_students_mass(class_id) {
    	if (class_id !== '') {
        $.ajax({
            url: '<?php echo site_url('administration/get_class_students_mass/');?>' + class_id ,
            success: function(response)
            {
