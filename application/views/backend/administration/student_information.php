                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo site_url('administration/student_marksheet/'.$row['student_id']);?>">
                                        ...
                                        <li>
                                            <a href="<?php echo site_url('administration/student_profile/'.$row['student_id']);?>">
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                          <a href="#" onclick="confirm_modal('<?php echo site_url('administration/delete_student/'.$row['student_id'].'/'.$class_id);?>');">
