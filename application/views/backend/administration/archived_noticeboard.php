            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('administration/noticeboard/remove_from_archived/' . $row['notice_id']);?>" >
                        ...
                        <!-- EDITING LINK -->
                        <li>
                            <a href="<?php echo site_url('administration/noticeboard_edit/' . $row['notice_id']);?>">
                        ...
                        <!-- DELETION LINK -->
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo site_url('administration/noticeboard/delete/' . $row['notice_id']);?>');">
