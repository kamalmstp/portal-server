<?php echo form_open(site_url('administration/marks_selector'));?>
...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-primary">
		    ...
		    <div class="panel-body">
		    	<?php echo form_open(site_url('administration/marks_update/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id));?>
...
<script type="text/javascript">
	...
	if (class_id !== '') {
	$.ajax({
            url: '<?php echo site_url('administration/marks_get_subject/');?>' + class_id ,
