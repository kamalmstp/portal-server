...
<?php echo form_open(site_url('administration/attendance_report_selector')); ?>
...
<div class="panel panel-primary ">
    ...
    <div class="panel-body">
        ...
        <?php ?>
                ...
                <center>
                    <a href="<?php echo site_url('administration/attendance_report_print_view/' . $class_id . '/' . $section_id . '/' . $month . '/' . $sessional_year); ?>"
