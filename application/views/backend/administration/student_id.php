...
<div class="id-card-holder">
    <div class="id-card">
        ...
        <hr>
            <img style="-webkit-user-select: none;max-width:200px;background-position: 0px 0px, 10px 10px;background-size: 20px 20px;background-image:linear-gradient(45deg, #eee 25%, transparent 25%, transparent 75%, #eee 75%, #eee 100%),linear-gradient(45deg, #eee 25%, white 25%, white 75%, #eee 75%, #eee 100%);" src="<?php echo site_url('administration/create_barcode/'.$student->nisn);?>">
...
<a  target="_blank" href="<?php echo site_url('administration/print_id/'.$student->student_id);?>" class="btn btn-primary"><i class="entypo-print"></i> Print</a>
