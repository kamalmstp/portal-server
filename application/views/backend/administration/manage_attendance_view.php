<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <?php echo form_open(site_url('administration/attendance_selector/')); ?>
        <div class="row">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <center>
                 ...
                 <?php echo form_open(site_url('administration/attendance_update/'. $class_id . '/' . $section_id . '/' . $timestamp)); ?>
                        ...
                        <tbody>
                            ...
                            foreach ($attendance_of_students as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->nisn; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input type="radio" name="status_<?php echo $row['attendance_id']; ?>" value="3" <?php if ($row['status'] == 3) echo 'checked'; ?>>&nbsp;<?php echo get_phrase('permit'); ?> &nbsp;
                                    </td>
                                </tr>
                            <?php
                            $select_id++;
