        ...
        <br>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(site_url('administration/book/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top','enctype'=>'multipart/form-data'));?>
...
<script type = 'text/javascript'>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#books').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo site_url('administration/get_books') ?>",
                "dataType": "json",
                "type": "POST",
            },
            "columns": [
    ...
    function book_delete_confirm(book_id) {
        confirm_modal('<?php echo site_url('administration/book/delete/');?>' + book_id);
    }
