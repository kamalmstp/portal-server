<hr />
<?php echo form_open(site_url('headmaster/marks_selector'));?>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<?php echo form_open(site_url('headmaster/marks_update/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id));?>
			<div class="panel panel-primary">
			    <div class="panel-heading">
			        <h3 class="panel-title"><?php echo get_phrase('marks_manager') ?></h3>
			    </div>
...
<script type="text/javascript">
	function get_class_subject(class_id) {
		if(class_id !== ''){
		$.ajax({
            url: '<?php echo site_url('headmaster/marks_get_subject/');?>' + class_id ,
