<?php 
$prota = $this->db->get_where('teaching_planning', array('learning_id' => $param2))->result_array();
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php
                echo form_open(site_url('headmaster/teaching_planning/add_prota/'.$row['learning_id']), array(
