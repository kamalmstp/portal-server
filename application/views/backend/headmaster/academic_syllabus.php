			...
			<div class="tabs-vertical-env">
				...
				?>
					<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
						<a href="<?php echo site_url('headmaster/academic_syllabus/'.$row['class_id']);?>">
								...
								<tr>
									...
									<td align="center">
										<a class="btn btn-default btn-xs"
											href="<?php echo site_url('headmaster/download_academic_syllabus/'.$row['academic_syllabus_code']);?>">
