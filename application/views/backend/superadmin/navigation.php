<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- STUDENT INFORMATION -->
        <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'opened active has-sub'; ?> ">
            <a href="#">
                <span><i class="fa flaticon-avatar"></i> <?php echo get_phrase('student_information'); ?></span>
            </a>
            <ul>
                <?php
                ...
                foreach ($classes as $row):
                    ...
                    <!--<li class="<?php if ($page_name == 'student_information' && $page_name == 'student_marksheet' && $class_id == $row['class_id']) echo 'active'; ?>">-->
                        <a href="<?php echo site_url('superadmin/student_information/' . $row['class_id']); ?>">
        ...
        <li class="<?php if ( $page_name == 'admin' ||
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'admin') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/admin'); ?>">
                ...
                <!-- <li class="<?php if ($page_name == 'parent') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/parent'); ?>">
                ...
                <li class="<?php if ($page_name == 'librarian') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/librarian'); ?>">
                        <i class="fa entypo-dot"></i>
                ...
                <li class="<?php if ($page_name == 'accountant') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/accountant'); ?>">
                        <i class="entypo-dot"></i>
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'academic_syllabus') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/academic_syllabus'); ?>">
            ...
            <ul>
                ...
                foreach ($classes as $row):
                    ...
                    <li class="<?php if ($page_name == 'subject' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/subject/' . $row['class_id']); ?>">
            ...
            <ul>
                ...
                foreach ($classes as $row):
                    ...
                    <li class="<?php if ($page_name == 'class_routine_view' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/class_routine_view/' . $row['class_id']); ?>">
        ...
        <li class="<?php if ($page_name == 'manage_attendance' ||
            ...
            <ul>
                    ...
                    <li class="<?php if (($page_name == 'daily_attendance' || $page_name == 'daily_attendance_view')) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/daily_attendance'); ?>">
            ...
            <ul>
                    ...
                    <li class="<?php if (($page_name == 'manage_attendance' || $page_name == 'manage_attendance_view')) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/manage_attendance'); ?>">
            ...
            <ul>
                    ...
                    <li class="<?php if (( $page_name == 'attendance_report' || $page_name == 'attendance_report_view')) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/attendance_report'); ?>">
            ...
            <ul>
                    ...
                    <li class="<?php if (( $page_name == 'setting' || $page_name == 'fingerprint_setting')) echo 'active'; ?>">
                        <a href="<?php echo site_url('superadmin/fingerprint_setting'); ?>">
        ...
        ?> ">
            ...
            <ul>
                <li class="<?php if ($page_name == 'exam') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/exam'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('exam_list'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/grade'); ?>">
        ...
        <!-- <li class="<?php //if ($page_name == 'invoice') echo 'active'; ?> ">
            <a href="<?php //echo base_url(); ?>index.php?superadmin/invoice">
        ...
        <li class="<?php if ( $page_name == 'book' ||
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'noticeboard' || $page_name == 'noticeboard_edit') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/noticeboard'); ?>">
                        <i class="entypo-dot"></i>
                ...
                <li class="<?php if ($page_name == 'message' || $page_name == 'group_message') echo 'active'; ?> ">
                    <a href="<?php echo site_url('superadmin/message'); ?>">
                        <i class="entypo-dot"></i>
        ...
        <li class="root-level" style="border-top: 1px solid #262a44; padding: 10px 0px;text-align: -webkit-center;">
            <?php echo form_open(site_url('superadmin/change_session') , array('id' => 'session_change'));?>
            <li>
