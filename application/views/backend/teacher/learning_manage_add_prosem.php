<?php 
$prosem = $this->db->get_where('learning_device', array('learning_id' => $param2))->result_array();
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php
                echo form_open(site_url('teacher/learning_manage/add_prosem/'.$row['learning_id']), array(
