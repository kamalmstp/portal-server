	...
	<div class="col-md-4">
		<div class="panel panel-primary">
		    ...
		    <div class="panel-body">
                <?php echo form_open(site_url('teacher/save_kikd'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_kikd');?></button>
                        </div>
                    </div>
                <?php echo form_close();?>
			</div>
