	...
	<div class="col-md-4">
		<div class="panel panel-primary">
		    ...
		    <div class="panel-body">
                <?php echo form_open(site_url('teacher/save_rpp'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_rpp');?></button>
                        </div>
                    </div>
                <?php echo form_close();?>
			</div>
            ...
            <div class="panel-body">
                <table class="table table-bordered datatable" id="">
                    ...
                    <?php 
						...
						$data = $this->db->get_where('rpp', array('id_teacher' => $this->session->userdata('teacher_id'), 'year' => $running_year))->result_array();
						foreach ($data as $row) {
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/view_rpp/'.$row['id']);?>');">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('teacher/edit_rpp/'.$row['id']);?>">
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo site_url('teacher/del_rpp/'.$row['id']);?>');">
