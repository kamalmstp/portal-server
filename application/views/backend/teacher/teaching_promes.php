	...
	<div class="col-md-4">
		<div class="panel panel-primary">
		    ...
		    <div class="panel-body">
                <?php echo form_open(site_url('teacher/save_promes'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input type="file" name="promes" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_promes');?></button>
                        </div>
                    </div>
                <?php echo form_close();?>
			</div>
