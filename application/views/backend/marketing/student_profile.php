...
<div class="profile-env">
	<header class="row">
        ...
        <span>
          ...
          ?>
          <a href="<?php echo site_url('marketing/student_information/'.$enroll_info->row()->class_id);?>">
      ...
      <li class="">
        ...
        <?php } ?>
          ...
          <?php echo get_phrase('average_grade_point');?> :
           ...
           <br> <br>
           <a href="<?php echo site_url('marketing/student_marksheet_print_view/'.$student_id.'/'.$row2['exam_id']);?>"
