...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <?php }else{?>
                <center>
                    <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/plan_status_junior/'.$plan_id);?>');"
    ...
    <div class="col-md-6">
        <?php if ($status->num_rows() > 0) {
                ...
                <?php } else if($row->status_result == 'Waiting') {?>
                    <center>
                    <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/plan_reconfirm_junior/'.$plan_id);?>');"
