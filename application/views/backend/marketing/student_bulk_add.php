<?php echo form_open(site_url('marketing/bulk_student_add_using_csv/import') ,
...
$('#submit_button').attr('disabled', 'disabled');
	...
	function get_sections(class_id) {
		if (class_id != "") {
			$.ajax({
	            url: '<?php echo site_url('marketing/get_sections/');?>' + class_id ,
	...
	$("#generate_csv").click(function(){
		...
		if(class_id == '' || section_id == '')
			...
			$.ajax({
			  	url: '<?php echo site_url('marketing/generate_bulk_student_csv/');?>' + class_id + '/' + section_id,
			  	success: function(response) {
