...
<div class="row">
    <div class="col-md-12">
        <a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('modal/popup/junior_school_add/');?>');"
                    ...
                    <td style="text-align: center;">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                <!-- EDITING LINK -->
                                <li>
                                    <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/junior_school_edit/'.$row['school_id']);?>');">
                                ...
                                <!-- DELETION LINK -->
                                <li>
                                    <a href="#" onclick="confirm_modal('<?php echo site_url('marketing/junior_school/delete/'.$row['school_id']);?>');">
