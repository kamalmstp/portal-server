...
<?php echo form_open(site_url('marketing/plan_elementary_status/'.$status_id.'/add/waiting') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>

<input type="hidden" name="type" value="<?php echo $status_type;?>">

<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo get_phrase('re-confirm at');?></label>
    <div class="col-sm-8">
    <input type="text" class="datepicker form-control" name="result_date"/>
    </div>
</div>
