		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('create_permission');?>
            	</div>
            </div>
			<div class="panel-body">

            <?php echo form_open(site_url('marketing/proses_elementary/permission_add/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input type="text" class="form-control" name="status_plan" value="Permission" disabled>
						</div>
					</div>
