...
<?php echo form_open(site_url('marketing/plan_elementary_status/'.$status_id.'/add/rejected') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <textarea onkeyup="changeTheBlankColor()" name="result" class="form-control" id="result" rows="8" cols="80" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"></textarea>
    </div>
</div>
