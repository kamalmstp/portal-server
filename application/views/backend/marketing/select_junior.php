<form class="" action="<?php echo site_url('marketing/plan_junior/select') ?>" method="post">
...
<div class="col-md-12" style="margin-top: 10px;">
    <table  class="table table-bordered table-striped">
      <span class="col-md-6" style="font-size: 13px; color: #616161; text-align: left; padding: 0; margin: 0;"><u><?php echo 'Junior High School List'; ?></u></span>
      <span class="col-md-4 pull-right" style="text-align: right; color: #616161;">
        <input type="checkbox" id="junior_school" onchange="checkAllBoxes(this)">&nbsp;<?php echo get_phrase('check_all'); ?>
      </span>
      <thead>
        <tr>
      ...
      <?php foreach ($list as $row):?>
        <tr>
          <td width = "10%">
            <input type="checkbox" class="junior_school" name="id[]" value="<?php echo $row['school_id']; ?>">
          </td>
