...
<div class="row" style="text-align: center;">
    ...
    <div class="col-sm-4">
        <div class="tile-stats tile-white">
            ...
            <strong><h3 style="color: #696969;">"<?php echo get_phrase('elementary_school'); ?>"</h3></strong>
...
<div class="row">
    <div class="col-md-12">
        ...
        <a href="<?php echo site_url('marketing/plan_elementary/approved');?>" class="btn btn-<?php echo $status == 'approved' ? 'primary' : 'white'; ?>">
            <?php echo get_phrase('approved');?>
        </a>
        <a href="<?php echo site_url('marketing/plan_elementary/rejected');?>" class="btn btn-<?php echo $status == 'rejected' ? 'primary' : 'white'; ?>">
            <?php echo get_phrase('rejected');?>
        </a>
        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/select_elementary/');?>');" class="btn btn-success pull-right">
