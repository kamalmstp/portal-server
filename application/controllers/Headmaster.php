...
class Headmaster extends CI_Controller
{
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = get_phrase('headmaster_dashboard');
  ...
  function student_profile($student_id)
  {
    ...
    function student_marksheet_print_view($student_id , $exam_id) {
        ...
        $this->load->view('backend/headmaster/student_marksheet_print_view', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('headmaster/subject/'.$data['class_id']), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = html_escape($this->input->post('name'));
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            redirect(site_url('headmaster/subject/'.$param3), 'refresh');
        }
    ...
    function marks_selector()
    {
        ...
        redirect(site_url('headmaster/marks_manage_view/'. $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id']) , 'refresh');
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        ...
        redirect(site_url('headmaster/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id), 'refresh');
    }
    else{
        $this->session->set_flashdata('error_message' , get_phrase('select_all_the_fields'));
        $page_data['page_name']  =   'marks_manage';
    ...
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/headmaster/marks_get_subject' , $page_data);
    }
    ...
    function upload_academic_syllabus()
    {
        ...
        redirect(site_url('headmaster/academic_syllabus/'. $data['class_id']) , 'refresh');
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        if ($operation == 'restore') {
            ...
            redirect(site_url('headmaster/backup_restore'), 'refresh');
        }
        if ($operation == 'delete') {
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            redirect(site_url('headmaster/manage_profile/'), 'refresh');
        }
    ...
    function class_routine_print_view($class_id , $section_id)
    {
        ...
        $page_data['class_id']   =   $class_id;
        $page_data['section_id'] =   $section_id;
        $this->load->view('backend/headmaster/class_routine_print_view' , $page_data);
    }
    ...
    function attendance_selector()
    {
        ...
        redirect(site_url('headmaster/manage_attendance_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['timestamp']),'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        redirect(site_url('headmaster/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp ), 'refresh');
    }
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('headmaster/noticeboard/'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title']     = html_escape($this->input->post('notice_title'));
            $data['notice']           = html_escape($this->input->post('notice'));
    ...
    function document($do = '', $document_id = '')
    {
        ...
        if ($do == 'upload') {
            ...
            redirect(site_url('headmaster/manage_document'), 'refresh');
        }
        if ($do == 'delete') {
    ...
    function teaching_planning($task = "", $learning_id = "")
    {
        ...
        if ($task == "create")
        {
            ...
            redirect(site_url('headmaster/teaching_planning'), 'refresh');
        }
        ...
        if ($task == "delete")
        {
            ...
            redirect(site_url('headmaster/study_material/'), 'refresh');
        }
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'send_new') {
            ...
            if ($_FILES['attached_file_on_messaging']['name'] != "") {
              if($_FILES['attached_file_on_messaging']['size'] > $max_size){
                $this->session->set_flashdata('error_message' , get_phrase('file_size_can_not_be_larger_that_2_Megabyte'));
                  redirect(site_url('headmaster/message/message_new/'), 'refresh');
              }
              else{
            ...
            redirect(site_url('headmaster/message/message_read/'.$message_thread_code), 'refresh');
        }
        ...
        if ($param1 == 'send_reply') {
            ...
            if ($_FILES['attached_file_on_messaging']['name'] != "") {
              if($_FILES['attached_file_on_messaging']['size'] > $max_size){
                $this->session->set_flashdata('error_message' , get_phrase('file_size_can_not_be_larger_that_2_Megabyte'));
                  redirect(site_url('headmaster/message/message_read/'.$param2), 'refresh');
    ...
    function group_message($param1 = "group_message_home", $param2 = ""){
      ...
      if ($param1 == 'group_message_read') {
        ...
        if ($_FILES['attached_file_on_messaging']['name'] != "") {
          if($_FILES['attached_file_on_messaging']['size'] > $max_size){
            $this->session->set_flashdata('error_message' , get_phrase('file_size_can_not_be_larger_that_2_Megabyte'));
              redirect(site_url('headmaster/group_message/group_message_read/'.$param2), 'refresh');
          }
          else{
    ...
    function question_paper($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "create")
        {
            ...
            redirect(site_url('headmaster/question_paper'), 'refresh');
        }
