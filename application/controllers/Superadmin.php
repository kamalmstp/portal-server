...
class Superadmin extends CI_Controller
{
    ...
    function admin($param1 = "", $param2 = "") {
        if ($this->session->userdata('super_login') != 1)
            ...
            if ($param1 == 'create') {
                ...
                redirect(site_url('superadmin/admin'), 'refresh');
            }
  ...
  function student_profile($student_id)
  {
    ...
    function get_sections($class_id)
    {
        ...
        $this->load->view('backend/superadmin/student_bulk_add_sections' , $page_data);
    }
    ...
    function student_marksheet_print_view($student_id , $exam_id) {
        ...
        $this->load->view('backend/superadmin/student_marksheet_print_view', $page_data);
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            // if($validation == 1) {
                ...
                $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            //}
            redirect(site_url('superadmin/student_add'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = html_escape($this->input->post('name'));
            $data['blood_group']        = html_escape($this->input->post('blood'));
            ...
            //         redirect(site_url('superadmin/student_information/' . $param3), 'refresh');
            //     }
            // }
    ...
    function delete_student($student_id = '', $class_id = '') {
      ...
      redirect(site_url('superadmin/student_information/' . $class_id), 'refresh');
    }
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        if($param1 == 'promote') {
            ...
            redirect(site_url('superadmin/student_promotion'), 'refresh');
        }
    ...
    function get_students_to_promote($class_id_from , $class_id_to , $running_year , $promotion_year)
    {
        ...
        $this->load->view('backend/superadmin/student_promotion_selector' , $page_data);
    }
    ...
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/parent'), 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']                   = html_escape($this->input->post('name'));
            $data['email']                  = html_escape($this->input->post('email'));
    ...
    function import_teacher_csv($param1 = '') {
        ...
        if ($param1 == 'import') {
            ...
            foreach ($csv as $row) {
              ...
              redirect(site_url('superadmin/teacher_import'), 'refresh');
           }
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/teacher'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = html_escape($this->input->post('name'));
            $data['email']       = html_escape($this->input->post('email'));
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/subject/' . $data['class_id']), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = html_escape($this->input->post('name'));
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(site_url('superadmin/subject/' . $param3), 'refresh');
        }
        $running_year = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
    ...
    function classes($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/classes'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = html_escape($this->input->post('name'));
    ...
    function upload_academic_syllabus()
    {
        ...
        redirect(site_url('superadmin/academic_syllabus/' . $data['class_id']), 'refresh');
    ...
    function delete_academic_syllabus($academic_syllabus_code) {
      ...
      $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
      redirect(site_url('superadmin/academic_syllabus'), 'refresh');
    ...
    function sections($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/section/' . $data['class_id']), 'refresh');
        }
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(site_url('superadmin/section'), 'refresh');
        }
    }
    ...
    function get_class_section_selector($class_id){
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/superadmin/get_class_section_selector', $page_data);
    }

    function get_class_subject_selector($class_id){
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/superadmin/get_class_subject_selector', $page_data);
    }
    ...
    function exam_marks_sms($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'send_sms') {
            ...
            redirect(site_url('superadmin/exam_marks_sms'), 'refresh');
        }
    ...
    function marks_selector()
    {
        ...
        redirect(site_url('superadmin/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id']), 'refresh');
    }
    else{
        $this->session->set_flashdata('error_message' , get_phrase('select_all_the_fields'));
        $page_data['page_name']  =   'marks_manage';
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        ...
        redirect(site_url('superadmin/marks_manage_view/' . $exam_id . '/' . $class_id . '/' . $section_id . '/' . $subject_id), 'refresh');
    }
    else{
        $this->session->set_flashdata('error_message' , get_phrase('select_all_the_fields'));
        $page_data['page_name']  =   'marks_manage';
    ...
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/superadmin/marks_get_subject' , $page_data);
    }
    ...
    function tabulation_sheet($class_id = '' , $exam_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(site_url('superadmin/tabulation_sheet/' . $page_data['class_id'] . '/' . $page_data['exam_id']), 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class and exam');
                redirect(site_url('superadmin/tabulation_sheet'), 'refresh');
            }
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function tabulation_sheet_print_view($class_id , $exam_id) {
        ...
        $page_data['class_id'] = $class_id;
        $page_data['exam_id']  = $exam_id;
        $this->load->view('backend/superadmin/tabulation_sheet_print_view' , $page_data);
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/grade'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = html_escape($this->input->post('name'));
            $data['grade_point'] = html_escape($this->input->post('grade_point'));
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/class_routine_add'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id']       = $this->input->post('class_id');
            if($this->input->post('section_id') != '') {
            ...
            redirect(site_url('superadmin/class_routine_view/' . $data['class_id']), 'refresh');
        }
        else if ($param1 == 'edit') {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(site_url('superadmin/class_routine_view/' . $class_id), 'refresh');
        }
    ...
    function class_routine_print_view($class_id , $section_id)
    {
        ...
        $page_data['class_id']   =   $class_id;
        $page_data['section_id'] =   $section_id;
        $this->load->view('backend/superadmin/class_routine_print_view' , $page_data);
    }

    function get_class_section_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/superadmin/class_routine_section_subject_selector' , $page_data);
    }
    ...
    function section_subject_edit($class_id , $class_routine_id)
    {
        ...
        $this->load->view('backend/superadmin/class_routine_section_subject_edit' , $page_data);
    }
    ...
    function fingerprint_setting($param1 = '', $param2 = '' , $param3 = ''){
        if ($this->session->userdata('super_login') != 1)
            ...
            if ($param1 == 'create') {
                ...
                $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
                redirect(site_url('superadmin/fingerprint_setting'), 'refresh');
            }
            if ($param1 == 'do_update') {
                $data['class_id']       = $this->input->post('class_id');
                $data['section_id']   = $this->input->post('section_id');
            ...
            if ($param1 == 'delete') {
                ...
                $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
                redirect(site_url('superadmin/fingerprint_setting/' . $param3), 'refresh');
            }
    ...
    {   if($this->input->post('class_id') == '') {
            if ($this->finger->get_data_absen('') != FALSE) {
                ...
                redirect(site_url('superadmin/daily_attendance'), 'refresh');
            }
        ...
        redirect(site_url('superadmin/daily_attendance_view/' . $data['class_id'] . '/' . $data['section_id']), 'refresh');
    }
    ...
    function get_section($class_id) {
          $page_data['class_id'] = $class_id;
          $this->load->view('backend/superadmin/manage_attendance_section_holder' , $page_data);
    }
    function attendance_selector()
    {
        ...
        redirect(site_url('superadmin/manage_attendance_view/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['timestamp']),'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        redirect(site_url('superadmin/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp) , 'refresh');
    }
	...
	function manage_attendance2($date='',$month='',$year='',$class_id='' , $section_id = '' , $session = '')
	{
		...
		if($_POST)
		{
			...
			$this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
			redirect(site_url('superadmin/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session) , 'refresh');
		}
        $page_data['date']       =	$date;
	...
	function attendance_selector2()
	{
		...
		redirect(site_url('superadmin/manage_attendance/'.$this->input->post('date').'/'.
     ...
     function attendance_report_print_view($class_id ='' , $section_id = '' , $month = '', $sessional_year = '') {
        ...
        $page_data['month']             = $month;
        $page_data['sessional_year']    = $sessional_year;
        $this->load->view('backend/superadmin/attendance_report_print_view' , $page_data);
    }
    ...
    {   if($this->input->post('class_id') == '' || $this->input->post('sessional_year') == '') {
            ...
            redirect(site_url('superadmin/attendance_report'), 'refresh');
        }
        $data['class_id']       = $this->input->post('class_id');
        $data['section_id']     = $this->input->post('section_id');
        $data['month']          = $this->input->post('month');
        $data['sessional_year'] = $this->input->post('sessional_year');
        redirect(site_url('superadmin/attendance_report_view/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['month'] . '/' . $data['sessional_year']), 'refresh');
    }
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/student_payment'), 'refresh');
        }
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(site_url('superadmin/income'), 'refresh');
        } else if ($param1 == 'edit') {
    ...
    function expense($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->db->insert('payment' , $data);
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/expense'), 'refresh');
        }
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/expense_category'), 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']   =   html_escape($this->input->post('name'));
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/book'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = html_escape($this->input->post('name'));
            $data['class_id']    = $this->input->post('class_id');
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/transport'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name']        = html_escape($this->input->post('route_name'));
            $data['number_of_vehicle'] = html_escape($this->input->post('number_of_vehicle'));
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/dormitory'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = html_escape($this->input->post('name'));
            $data['number_of_room'] = html_escape($this->input->post('number_of_room'));
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(site_url('superadmin/noticeboard'), 'refresh');
        }
        if ($param1 == 'do_update') {
    ...
    function reload_noticeboard() {
        $this->load->view('backend/superadmin/noticeboard');
    }
    /* private messaging */
        ...
        if ($param1 == 'send_new') {
            ...
            if ($_FILES['attached_file_on_messaging']['name'] != "") {
              if($_FILES['attached_file_on_messaging']['size'] > $max_size){
                ...
                redirect(site_url('superadmin/message/message_new'), 'refresh');
              }
              else{
    ...
    function group_message($param1 = "group_message_home", $param2 = ""){
      ...
      elseif ($param1 == 'group_message_read') {
        ...
        if ($_FILES['attached_file_on_messaging']['name'] != "") {
          if($_FILES['attached_file_on_messaging']['size'] > $max_size){
            $this->session->set_flashdata('error_message' , get_phrase('file_size_can_not_be_larger_that_2_Megabyte'));
            redirect(site_url('superadmin/group_message/group_message_read/' . $param2), 'refresh');
          }
          else{
    ...
    function frontend_events($param1 = '', $param2 = '') {
      if ($param1 == 'add_event') {
        ...
        redirect(site_url('superadmin/frontend_pages/events'), 'refresh');
      }
    ...
    function frontend_gallery($param1 = '', $param2 = '', $param3 = '') {
      if ($param1 == 'add_gallery') {
        ...
        redirect(site_url('superadmin/frontend_pages/gallery'), 'refresh');
      }
      ...
      if ($param1 == 'upload_images') {
        ...
        redirect(site_url('superadmin/frontend_pages/gallery_image/'.$param2), 'refresh');
      }
      if ($param1 == 'delete_image') {
        ...
        redirect(site_url('superadmin/frontend_pages/gallery_image/'.$param3), 'refresh');
      }
    ...
    function frontend_news($param1 = '', $param2 = '') {
      if ($param1 == 'add_news') {
        ...
        redirect(site_url('superadmin/frontend_pages/news'), 'refresh');
      }
      if ($param1 == 'edit_news') {
    ...
    function frontend_settings($task) {
      if ($task == 'update_terms_conditions') {
        ...
        redirect(site_url('superadmin/frontend_pages/terms_conditions'), 'refresh');
      }
      if ($task == 'update_about_us') {
        ...
        redirect(site_url('superadmin/frontend_pages/about_us'), 'refresh');
      }
      if ($task == 'update_privacy_policy') {
        ...
        redirect(site_url('superadmin/frontend_pages/privacy_policy'), 'refresh');
      }
      if ($task == 'update_general_settings') {
        ...
        redirect(site_url('superadmin/frontend_pages/general'), 'refresh');
      }
      if ($task == 'update_slider_images') {
        ...
        redirect(site_url('superadmin/frontend_pages/homepage_slider'), 'refresh');
      }
    }
    ...
    {
        $this->load->view('backend/superadmin/change_session');
    }
    ...
    function sms_settings($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'clickatell') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(site_url('superadmin/sms_settings'), 'refresh');
        }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		if ($param1 == 'update_phrase') {
			...
			redirect(site_url('superadmin/manage_language/edit_phrase/'.$language), 'refresh');
		}
		if ($param1 == 'do_update') {
    ...
    function teaching_planning($task = "")
    {
        ...
        if ($task == "delete")
        {
            ...
            redirect(site_url('superadmin/study_material'), 'refresh');
        }
    ...
    function librarian($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/librarian'), 'refresh');
        }
    ...
    function accountant($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(site_url('superadmin/accountant'), 'refresh');
        }
...
//                    $data2['roll']        = $row[1];
                ...
                //       redirect(site_url('superadmin/student_bulk_add'), 'refresh');
                //     }
                //     elseif($array_size > 2){
    ...
    function print_id($id){
        if ($this->session->userdata('super_login') != 1)
            redirect(site_url('login'), 'refresh');
        $data['id'] = $id;
        $this->load->view('backend/superadmin/print_id', $data);
    }
    ...
    function manage_online_exam($param1 = "", $param2 = ""){
        ...
        if ($param1 == 'create') {
            if ($this->input->post('class_id') > 0 && $this->input->post('section_id') > 0 && $this->input->post('subject_id') > 0) {
                ...
                $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
                redirect(site_url('superadmin/manage_online_exam'), 'refresh');
            }
            else {
    ...
    function online_exam_questions_print_view($online_exam_id, $answers) {
        ...
        $this->load->view('backend/superadmin/online_exam_questions_print_view', $page_data);
    }
    ...
    function load_question_type($type, $online_exam_id) {
        ...
        $page_data['online_exam_id'] = $online_exam_id;
        $this->load->view('backend/superadmin/online_exam_add_'.$type, $page_data);
    }
    ...
    function manage_online_exam_question($online_exam_id = "", $task = "", $type = ""){
        ...
        if ($task == 'add') {
            ...
            redirect(site_url('superadmin/manage_online_exam_question/'.$online_exam_id), 'refresh');
        }
    ...
    function get_payment_history_for_ssph($student_id) {
        $page_data['student_id'] = $student_id;
        $this->load->view('backend/superadmin/student_specific_payment_history_table', $page_data);
    }
